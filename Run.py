...
class Run:
    ...
    def main(self):
        ...
        strng = "TurbulenceStatistics_DP_baseline_otsuby4_gradientcalctest_100imgs_withvoriticity_interfacecheck_fixeddirectionality_spatialfreq2"#otsuby1_velmagsqrt_shearlayeranglemodify_overlayangleadjust
