class Settings:
    def __init__(self):
        ...
        self.start_loc = 1.0  # Image cutoff limits along x axis, in mm
        self.end_loc = 49.0  # Image cutoff limits along x axis, in mm
        ...
        self.shear_num = 101  # number of points in shear layer
